...
function Redraw(){
	...
	imagePane.innerHTML = '<a href="#'+nextIdx+'"><img id="albumimg" class="main'+imgClass+'" src="'+linkArray[currentImage]+'" /></a>';
...
function ScrollToon(){
    ...
    for(var j=0; j<imageCount; j++){
        ImageBuf += '<img id="scrollimg_'+j+'" class="Scrolling" src="'+linkArray[j]+'">\n';
    }
    var ScrollList = document.getElementById('ScrollList');
    ScrollList.innerHTML = ImageBuf;
